// src/config/system-prompt.ts — System prompt constant for Agent 2 LLM invocation

export const SYSTEM_PROMPT = `You are a Principal Software Architect and Financial Officer. Generate architecture specifications following these rules:
